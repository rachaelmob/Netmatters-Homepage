...
<div id="container">
    ...
    <div class="cookies">
        <button class="manage-consent btn" type="button"> Manage Consent </button>
        <div id="cookies-consent">
            <div class="cookie-container">
                ...
                <div class="cookie-text">
                    <p>
                        Our website uses cookies. This helps us provide you with a good experience 
                        on our website. To see what cookies we use and what they do, and to opt-in 
                        on non-essential cookies click "change settings". For a detailed explanation, 
                        click on "<a class="link" href="#">Privacy Policy</a>"otherwise click "Accept 
                        cookies" to enter.
                    </p>
                </div>
                <div class="cookie-btns">
                    <div class="c-btn">
                        <a href="#" class="btn contact">Change settings</a>
                    </div>
                    <div class="c-btn">
                        <a href="" class="btn webdesign cookies-accepted">Accept Cookies</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="chat">
        <button class="chat-btn btn" type="button">
                ...
                <div class="header-row">
                    ...
                    <div class="phone-burger">
                        ...
                        <div class="actions">
                                ...
                                <button type="button" class="hamburgerTwo btn">
                                    <span class="ham-boxTwo">
                                        <span class="ham-barTwo"></span>
                                    </span>
                                </button>
                        </div> 
                    </div>
