    ...
    <div class="container">
        <div class="footer-all"> 
                <div class="footer-social-menu"> 
                    <div class="netlogo-footer"> 
                        <img src="./img/netmatters-logo-footer.png" alt="Netmatters Logo">
                    </div> 
                    <h4>Follow us on:</h4>
                    <div class="social-logos"> 
                        <a class="facebook btn-primary" href="#">
                            <span><i class="fa-brands fa-facebook-f"></i></span>
                        </a>  
                        <a class="linkedin btn-primary" href="#">
...
<div class="footer-bottom">
    <div class="container">
        <div class="license">
            <span>© Copyright Netmatters 2024.</span>
            <span>All rights reserved.</span>
            <span class="hidephen">-</span>
            <a href="#"> Sitemap
            </a>
        </div>
    </div>
